...
![1分钟快速体验](https://github.com/silvesterchen/chat-mindmap/raw/main/docs/demo.gif) <!-- 建议补充演示动图：用ScreenToGif录制10秒核心操作（新建导图→双Agent问答→节点关联），放在项目根目录/docs下，无动图可先注释此句，后续补充 -->
...
- 🆕 新增场景模板（项目规划/学习笔记预设模板，开箱即用） <!-- 若已开发模板可保留，未开发可注释此句 -->
